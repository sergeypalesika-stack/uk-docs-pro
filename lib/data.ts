...
export const DEFAULT_TODOS: TodoItem[] = [
  ...
  { id: 't2',  text: 'Download CITB HS&E revision app (free)',       textRu: 'Скачать приложение CITB для подготовки к тесту',     done: false, week: 0, category: 'qualification' },
...
export const DEFAULT_DOCS: Doc[] = [
  {
    ...
    notes: 'Status: Homes for Ukraine | DOB: 8 July 1985 | Nationality: UKR',
    notesRu: 'Статус: Homes for Ukraine | ДР: 8 июля 1985 | Гражданство: Украина',
    pinned: true,
  },
  {
    id: 'sharecode_work',
  ...
  },
  {
    ...
    validFrom: '',
    validUntil: '2026-07-20',
    notes: 'Prove status to landlord/authority → gov.uk/check-immigration-status',
    notesRu: 'Подтвердить статус арендодателю → gov.uk/check-immigration-status',
    pinned: false,
  },
]
